...
void GraphicsWindowWin32::init()
{
	...
	//edit by zengjinchong
	_isNotOffScreen = true;
...
bool GraphicsWindowWin32::realizeImplementation()
{
	...
	//edit by zengjinchong
    if (_ownsWindow && _isNotOffScreen)
    {
        //
...
//edit by zengjinchong
void GraphicsWindowWin32::SetOffScreen(bool isOffScreen)
{
	_isNotOffScreen = !isOffScreen;
}
